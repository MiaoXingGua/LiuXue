...
typedef enum {
    ERequestType_Init = 0,
    ERequestType_LandingCalls,
    ERequestType_VoiceCode,
    ERequestType_Group_CreateGroup,
    ERequestType_Group_ModifyGroup,
    ERequestType_Group_DeleteGroup,
    ERequestType_Group_QueryGroup,
    ERequestType_Group_GetPublicGroups,
    ERequestType_Group_SearchPublicGroups,
    ERequestType_Group_JoinGroup,
    ERequestType_Group_InviteJoinGroup,
    ERequestType_Group_DeleteGroupMember,
    ERequestType_Group_LogoutGroup,
    ERequestType_Member_AddMember,
    ERequestType_Member_ModifyMember,
    ERequestType_Member_DeleteMember,
    ERequestType_Member_QueryMember,
    ERequestType_Member_QueryGroup,
    ERequestType_Member_ForbidSpeak,
    ERequestType_Member_AskJoin,
    ERequestType_Member_InviteGroup,
    ERequestType_GrupCard_ModifyCard,
    ERequestType_GrupCard_QueryCard,
    ERequestType_GetServiceNum,
    ERequestType_GetCategoryList,
    ERequestType_GetExpertList,
    ERequestType_LockExpert
} ERequestType;
