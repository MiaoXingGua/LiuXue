...
+ (void)registerForNetworkReachabilityNotifications
{
	[[TReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[TReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
