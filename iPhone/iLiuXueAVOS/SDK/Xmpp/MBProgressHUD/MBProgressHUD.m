...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        UIView *_backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 70, 70)];
...
- (void)layoutSubviews {
	...
	CGFloat maxWidth = bounds.size.width - 20;
...
//								roundf((allRect.size.height - size.height) / 2) + self.yOffset, size.width*0.8, size.height*0.8);
//	float radius = 10.0f;
