...
- (void)gotoIncomingCallView:(NSTimer*)theTimer
{
    ...
    else
    {
        if (self.imagePicker)
        {
            ...
            [self.imagePicker presentViewController:incomingCallView animated:YES completion:nil];
        }
        else if (self.messageCompose)
        {
            //弹出系统的短信界面后来电的显示
            
            [self.messageCompose presentViewController:incomingCallView animated:YES completion:nil];
        }
        else
        {
            
            [self presentViewController:incomingCallView animated:YES completion:nil];
        }
