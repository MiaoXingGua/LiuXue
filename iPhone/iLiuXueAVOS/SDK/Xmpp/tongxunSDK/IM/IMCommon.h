...
//当前登录用户 数据库文件名
@property (nonatomic, retain) NSString *my;
...
@property (nonatomic, assign) BOOL isSender;//是否是发消息 YES发消息 NO接受的消息
...
@interface IMGroupMessageObj: NSObject

//消息id
@property (nonatomic, retain) NSString *msgId;

@property (nonatomic, retain) NSString *my;//当前登录用户 数据库文件名

@property (nonatomic, retain) NSString *sender;//发送消息人

@property (nonatomic, retain) NSString *groupId;//接收消息的群 群聊 表名
